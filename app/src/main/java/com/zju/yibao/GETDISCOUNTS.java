...
public class GETDISCOUNTS extends Activity implements GetJson {
    private ProgressBar progressBar;
    private TextView tvMessage;

    private String string_http = LocalConfig.SERVICE_IP + "/ArtEducation/student/getDiscountNum.action";
    ...
    public void getJsonString(String s) {
        ...
        try {
            ...
            switch (jsonObject.getInt("resultCode")) {
                case 0:
                    Toast.makeText(this, "领取优惠券成功,请在\"我的优惠券中查看\"", Toast.LENGTH_SHORT).show();
                    break;
                default:
