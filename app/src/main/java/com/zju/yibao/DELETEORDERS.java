...
public class DELETEORDERS extends Activity implements GetJson {
    private ProgressBar progressBar;
    private TextView tvMessage;

    private String string_http = LocalConfig.SERVICE_IP + "/ArtEducation/student/deleteOrdersCar.action";
